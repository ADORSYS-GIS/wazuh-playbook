...
# 1. The Overview Dashboard (Image 1)
...
**Critical/High (Levels 12-15+):** These are priority-one threats (e.g., a confirmed exploit or rootkit) that require immediate action.
...
# 2. Wazuh Dashboard – Reporting Page (Field-by-Field Explanation)
