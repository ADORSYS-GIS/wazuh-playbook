...
Deployment a patched version of the `wazuh-helm`, where our custom Yara rules have been updated to trigger Yara and Yara active response actions' alerts on all supporting agents.
...
- Feature(s) / Fix(es):
  - [https://github.com/ADORSYS-GIS/wazuh/issues/237] Improve Yara's Incident Response Workflow

- Related Commits / Merge Requests:
  - [https://github.com/ADORSYS-GIS/wazuh-helm/pull/89] Add yara decoders and rules to create alerts for active response actions taken and their status 
---
...
- [ ] Yara and Yara active response actions' alerts being properly generated and displayed on dashboard when triggered
