### Step-by-Step Playbook: Create Partition
...
**Goal:**
* Shrink the existing `/dev/nvme0n1p5`
* Create new partitions for `/var`, `/var/tmp`, `/var/log`, `/var/log/audit` and `/home` from the freed space.
...
1.  **Boot from Ubuntu Live USB (Try Ubuntu):**
    * This is crucial because you cannot modify partitions that are currently in use by the running OS.
...
6.  **Remove Original Directories (AFTER Successful Copy!):**
 ...
 # Note: var/tmp, /var/log & /var/log/audit is inside var
        ```
